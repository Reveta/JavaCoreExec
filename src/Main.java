...
import edication.Exec.Epam1.Aquarium;
import edication.Exec.Epam1.ArrayExes;
//import edication.Exec.Epam1.ArrayExesxesIRA;
...
//        User user = new User("Ira", 48);
//        System.out.println(user.moonMass());

//        int array[];
//        array = Array.creatArray(5);
//        System.out.println(Array.soutArray(Array.plusTen(array)));

//        String message = "Reveta wont fuck this world";
//        message = Replace.cenzor(message);
//        System.out.println(message);

//        Flash flash = new Flash(7.2);
//        System.out.println(flash.distance());

//        int[] array = {12, 44, 35, 51, 13, 15, 58, 45};
//        System.out.println(ArrayExesIRA.soutArray(array));


//        Aquarium aquariumr;
//        aquariumr = new Aquarium(13,13,14,"glass");
//        aquariumr.addFish("Clown");
